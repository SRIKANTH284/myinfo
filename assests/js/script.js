...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Badavath Srikanth";
        $("#favicon").attr("href","assests/images/sri.png");
    }
    else {
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Data Science " , "AWS" , "Front End Devlopment", "Back End Devlopment", "Machine Learning","Artificial Intelligence","Cloud DevOps"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
//   s1.async=true;
//   s1.src='https://embed.tawk.to/648defbbcc26a871b0232a41/1h3570tg3';
//   s1.charset='UTF-8';
